      ...
      <div v-for="item in notices" :key="item.f1">
          ...
          <el-card class="box-card" >
            ...
            <el-row>
                ...
                <el-button type="text" @click="del(item.f1,item.f4)">完成上菜</el-button>
                </el-col>
            </el-row>
            </div>   
        </el-card>
   ...
   inject:['reload'],
    ...
    methods: {
       testt()
      {
        ...
        requestData("get","getServeDishes",require_data).then((resp)=>{
      ...
      del(f1,f4)
      {
        ...
        requestData("post","changeServeDishes",data).then(()=>{});
        this.reload();
      },
      fresh()
      {
