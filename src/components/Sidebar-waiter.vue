<template>
    ...
    >
     <el-menu-item-group>
          ...
          <el-menu-item index="1-1">点餐</el-menu-item>
          <el-menu-item index="1-2">查看订单</el-menu-item>
          <el-menu-item index="1-2">上菜提示</el-menu-item>
          <el-menu-item index="1-2">查看公告</el-menu-item>
      </el-menu-item-group>
